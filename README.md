...
- [dgenzer/surify-cli](https://github.com/dgenzer/surify-cli) - 🧙🏼‍♂️Generate suricata-rules from collection of IOCs (JSON, CSV or flags) based on your suricata template.
