...
- [BasGame1/Pixelify-Next](https://github.com/BasGame1/Pixelify-Next) - Magisk /KSU module to enables pixel exclusive features up to android 17
...
- [regiscaio/fedora-galaxy-book4-ultra](https://github.com/regiscaio/fedora-galaxy-book4-ultra) - Fedora Workstation no Samsung Galaxy Book4 Ultra
...
- [FossifyOrg/Messages](https://github.com/FossifyOrg/Messages) - An easy and quick way of managing SMS and MMS messages without ads.
- [neon-mmd/websurfx](https://github.com/neon-mmd/websurfx) - :rocket: An open source alternative to searx which provides a modern-looking :sparkles:, lightning-fast :zap:, privacy respecting :disguised_face:, secure :lock: meta search engine
- [Siddhesh2377/ToolNeuron](https://github.com/Siddhesh2377/ToolNeuron) - Encrypted & Privacy First, On Android Device AI App
- [facebook/docusaurus](https://github.com/facebook/docusaurus) - Easy to maintain open source documentation websites.
- [jksalcedo/librefind](https://github.com/jksalcedo/librefind) - Discover and replace proprietary apps with FOSS alternatives
- [nvckai/Discord-Web-Auto-Quest-Extension](https://github.com/nvckai/Discord-Web-Auto-Quest-Extension) - A Chrome extension that automatically completes all Discord Quests
- [siddharthvaddem/openscreen](https://github.com/siddharthvaddem/openscreen) - Create stunning demos for free. Open-source, no subscriptions, no watermarks, and free for commercial use. An alternative to Screen Studio.
...
- [R0rt1z2/fenrir](https://github.com/R0rt1z2/fenrir) - [CLOSED] Let's control MediaTek's bootchain
...
- [0xjohnnydev/FilzaSlop](https://github.com/0xjohnnydev/FilzaSlop) - FilzaJailedDS fork with container access for iOS 18, iOS 26, and iOS 27 beta 1–4. See README for per-bug status.
...
- [ang3lo-azevedo/vendor_nothing_Spacewar](https://github.com/ang3lo-azevedo/vendor_nothing_Spacewar) - New DerpFest vendor tree for Nothing Phone (1) (Spacewar). Forked from TheMuppets.
- [KanishkTheDerp/scripts](https://github.com/KanishkTheDerp/scripts) - 
- [V4bel/Januscape](https://github.com/V4bel/Januscape) - 
- [V4bel/ITScape](https://github.com/V4bel/ITScape) - 
- [llnl/OGhidra](https://github.com/llnl/OGhidra) - OGhidra bridges Large Language Models (LLMs) via Ollama with the Ghidra reverse engineering platform, enabling AI-driven binary analysis through natural language. Interact with Ghidra using conversati
...
- [V4bel/Zapscape](https://github.com/V4bel/Zapscape) - 
- [XD-MHLOO/Osintgraph](https://github.com/XD-MHLOO/Osintgraph) - About Osintgraph is an open-source tool that collects Instagram data, followers, and followees, storing them in Neo4j. It helps you easily map and analyze a target's social network, revealing interest
- [mito753/Kernel-Exploit-Dojo](https://github.com/mito753/Kernel-Exploit-Dojo) - CTF kernel exploitation notes, PoCs, exploits, and writeups.
- [ang3lo-azevedo/KeyPull](https://github.com/ang3lo-azevedo/KeyPull) - KeyPull is a command-line utility to extract keybox/keystore data from your Android phone
- [ims0nic/KeyPull](https://github.com/ims0nic/KeyPull) - KeyPull is a command-line utility to extract keybox/keystore data from your Android phone
...
- [x3ctf/challenges-2025](https://github.com/x3ctf/challenges-2025) - x3CTF Challenges 2025
- [0xadamastor/WiredWatcher](https://github.com/0xadamastor/WiredWatcher) - Initial recon tool for CTFs.
- [0xadamastor/C.A.L.M.A.](https://github.com/0xadamastor/C.A.L.M.A.) - Containerized Automated Lazy Mail Anti-nasties
...
- [hiz0147/HizSteamButton](https://github.com/hiz0147/HizSteamButton) - HizSearch Steam Button
- [leludo84/vol3-linux-profiles](https://github.com/leludo84/vol3-linux-profiles) - Volatility3 Linux profiles
- [solst-ice/gba-hashcat](https://github.com/solst-ice/gba-hashcat) - Password cracker for the GAME BOY Advance, supporting SHA256
- [tomchop/volatility-autoruns](https://github.com/tomchop/volatility-autoruns) - Autoruns plugin for the Volatility framework
...
- [thcolin/gamepad-media-center-aggregator](https://github.com/thcolin/gamepad-media-center-aggregator) - 🎮 📺 GMCA - A Gamepad (Switch, PS Vita, Linux, PS4) Media Center Aggregator (Plex, Jellyfin, Emby or Stremio)
- [shodowlo/NX-torrent-player](https://github.com/shodowlo/NX-torrent-player) - NX Torrent Player: Stremio on Nintendo Switch
...
- [tls-attacker/Censor-Scanner](https://github.com/tls-attacker/Censor-Scanner) - 
- [divyam234/installer](https://github.com/divyam234/installer) - One-liner for installing binaries from Github releases
- [binwiederhier/ntfy-android](https://github.com/binwiederhier/ntfy-android) - Android app for ntfy.sh
- [SpriteOvO/closely](https://github.com/SpriteOvO/closely) - Subscribe to updates from people you follow, from any platform to any platform
- [DavidBerdik/Let-Me-Downgrade](https://github.com/DavidBerdik/Let-Me-Downgrade) - Let Me Downgrade - Add support for downgrading apps on Android 12 through 17.
- [noah-nuebling/mac-mouse-fix](https://github.com/noah-nuebling/mac-mouse-fix) - Mac Mouse Fix - Make Your $10 Mouse Better Than an Apple Trackpad!
- [ArrCee76/magnetar](https://github.com/ArrCee76/magnetar) - Detect torrent hashes on any page. Send to Real-Debrid, RDT Client, TorBox, Alldebrid, Premiumize or your local client. Built-in redirect and popup blocker. Extension available on Firefox and Chrome w
...
- [durranilab/httpsms](https://github.com/durranilab/httpsms) - Laravel HTTP SMS Sender Easy HTTP (GET/POST) SMS Package for Indian SMS Service Providers.
- [Arihany/WinlatorWCPHub](https://github.com/Arihany/WinlatorWCPHub) - An automated hub for distributing essential WCPs
...
- [navneet851/spotify-clone-jetpack-compose](https://github.com/navneet851/spotify-clone-jetpack-compose) - spotify clone made using jetpack compose
- [Mayankdev0923/Echo-Music](https://github.com/Mayankdev0923/Echo-Music) - customizing for my own preffered look.
...
- [harborstremio-linux/harbor-linux-builds](https://github.com/harborstremio-linux/harbor-linux-builds) - 
...
- [1RandomDev/showly-oss](https://github.com/1RandomDev/showly-oss) - Fork of the Showly app without Google Trackers.
- [IgnisDa/ryot](https://github.com/IgnisDa/ryot) - Roll your own tracker!
- [holmat98/FootballScore](https://github.com/holmat98/FootballScore) - Android application for checking the results of football games
- [zachvlat/LiveMatches](https://github.com/zachvlat/LiveMatches) - A modern Android app for tracking live scores from different sports.
...
- [DCRichards/stravadora](https://github.com/DCRichards/stravadora) - A simple map-centric Strava client for Android
- [alexgasconn/StravaStats](https://github.com/alexgasconn/StravaStats) - Web App used to analyze Strava data. Trying to cover all strava premium features for free
- [ang3lo-azevedo/Escape-Launcher](https://github.com/ang3lo-azevedo/Escape-Launcher) - A minimalist android launcher to help you quit your phone addiction
...
- [fynks/configs](https://github.com/fynks/configs) - Various configs and stuff :)
- [DavidePrette/niri-shake-cursor](https://github.com/DavidePrette/niri-shake-cursor) - macOS-style shake-to-find cursor for the niri Wayland compositor
- [SHORiN-KiWATA/shorin-niri](https://github.com/SHORiN-KiWATA/shorin-niri) - 
- [SergioRibera/niri](https://github.com/SergioRibera/niri) - [Contributing] A scrollable-tiling Wayland compositor.
...
- [fynks/awesome-kernelsu](https://github.com/fynks/awesome-kernelsu) - A curated list of KernelSU & its forks, tools, modules, and documentation
- [Reafun/mailfromduck](https://github.com/Reafun/mailfromduck) - Mail from Duck is a Firefox browser extension that integrates with DuckDuckGo's email generation page and provides the ability to send messages from the private Duck addresses.
- [yesyesufcurs/DDG-Mail-Alias-Generator-App](https://github.com/yesyesufcurs/DDG-Mail-Alias-Generator-App) - Android app with Quick Settings functionality to quickly generate DuckDuckGo Mail aliases on the fly.
...
- [nathan1x/letterboxd-trakt-sync](https://github.com/nathan1x/letterboxd-trakt-sync) - Script to sync your Letterboxd ratings to your Trakt account.
- [daveblx/letterboxd-trakt-sync](https://github.com/daveblx/letterboxd-trakt-sync) - Script to sync your Letterboxd ratings to your Trakt account.
- [AndroidAppz/LuckyPatcher](https://github.com/AndroidAppz/LuckyPatcher) - LuckyPatcher App for Android. -
...
- [dzumq/Linux-Larp](https://github.com/dzumq/Linux-Larp) - Linux Distro for Larpers
...
- [BringusStudios/luckma-ps5](https://github.com/BringusStudios/luckma-ps5) - Automated jailbreak and linux loader for the PS5 utilizing Luckfox SBCs
...
- [blackfox113/censorshipbypassguide](https://github.com/blackfox113/censorshipbypassguide) - Censorship Bypass Guide
...
- [TimonCantCode/acestreamz](https://github.com/TimonCantCode/acestreamz) - 
- [HKUDS/AI-Trader](https://github.com/HKUDS/AI-Trader) - "AI-Trader: 100% Fully-Automated Agent-Native Trading"
- [harborstremio/harbor](https://github.com/harborstremio/harbor) - A Custom Stremio Client Built for Adventure!
...
- [JeoCrypto/arcus_ode_lab](https://github.com/JeoCrypto/arcus_ode_lab) - A public model-forensics lab for Augusta Labs' Ode Triunfal challenge. Built to reverse-engineer the checkpoint, inspect tokenizer behavior, probe prompts, score candidates, and document uncertainty.
- [diomonogatari/arcus-ode-triunfal-lab](https://github.com/diomonogatari/arcus-ode-triunfal-lab) - my take on the challenge
...
- [Vertex-Mods/Zen-Live-Calendar](https://github.com/Vertex-Mods/Zen-Live-Calendar) - Brings the live calendar functionality from Arc to Zen, making it feel as native as possible.
- [Vertex-Mods/Reopen-Closed-Tabs-Menu](https://github.com/Vertex-Mods/Reopen-Closed-Tabs-Menu) - Creates a Menu to search and reopen recently closed tabs
- [Vertex-Mods/Zen-Command-Palette](https://github.com/Vertex-Mods/Zen-Command-Palette) - A powerful, extensible command interface for Zen Browser, seamlessly integrated into the URL bar. Inspired by Raycast and Arc.
- [kkugot/blended-addressbar](https://github.com/kkugot/blended-addressbar) - A page-aware addressbar that blends Zen chrome with the active website.
- [Vertex-Mods/Zen-Tidy-Downloads](https://github.com/Vertex-Mods/Zen-Tidy-Downloads) - Rename your downloads with ease, and do it in style!
- [Vertex-Mods/Zen-Tidy-Tabs](https://github.com/Vertex-Mods/Zen-Tidy-Tabs) - Sort your tabs using Firefox's local AI but make it look awesome! Includes ATG install.
...
- [TheGostsniperfr/antigravity2.0-nix](https://github.com/TheGostsniperfr/antigravity2.0-nix) - 
...
- [powerofthe69/proton-cachyos-nix](https://github.com/powerofthe69/proton-cachyos-nix) - Personal Nix flake for Proton-CachyOS. Deprecated, but not unmaintained. I recommend the larger NUR that includes mesa-git here:
...
- [acama/xrop](https://github.com/acama/xrop) - Tool to generate ROP gadgets for ARM, AARCH64, x86, MIPS, PPC, RISCV, SH4 and SPARC
...
- [zardus/pwnsh](https://github.com/zardus/pwnsh) - tools for shellcoding
...
- [superfly310/muhn-pace-subtitles](https://github.com/superfly310/muhn-pace-subtitles) - Subtitles for released One Pace fan edit episodes
- [Team-HYDRV/HYDRV](https://github.com/Team-HYDRV/HYDRV) - Android release browsing, kept clean.
- [m-bain/whisperX](https://github.com/m-bain/whisperX) - WhisperX:  Automatic Speech Recognition with Word-level Timestamps (& Diarization)
- [34306/vphone-aio](https://github.com/34306/vphone-aio) - 1 script run the vphone
- [ang3lo-azevedo/fun-pace-subs](https://github.com/ang3lo-azevedo/fun-pace-subs) - Moved to ang3lo-azevedo/fun-pace-public-subtitles. Unofficial subtitle generator for the One Piece "Fun Pace" project.
...
- [ang3lo-azevedo/HATS](https://github.com/ang3lo-azevedo/HATS) - Automated All-in-One (AIO) custom firmware and homebrew packages for modded Nintendo Switch devices.
...
- [ITotalJustice/untitled](https://github.com/ITotalJustice/untitled) - Batch title uninstaller for the Nintendo Switch
...
- [rwxrob/ytclip](https://github.com/rwxrob/ytclip) - 
...
- [ExTV/android_kernel_msm-5.4_nothing_sm7325](https://github.com/ExTV/android_kernel_msm-5.4_nothing_sm7325) - Nothing Phone 1 (Spacewar) kernel source - msm-5.4 QGKI with DroidSpaces, Docker & NetHunter support
...
- [Andycodeman/samsung-galaxy-book-linux-fixes](https://github.com/Andycodeman/samsung-galaxy-book-linux-fixes) - Linux fixes for Samsung Galaxy Book 3, 4 & 5 — webcam, speakers, microphone, and more
...
- [melogabriel/tinfoil-shops](https://github.com/melogabriel/tinfoil-shops) - Repository with list of links hosts to active and working tinfoil shops for Nintendo Switch.
...
- [StudioKeys-Dumps/vendor_nothing_Spacewar](https://github.com/StudioKeys-Dumps/vendor_nothing_Spacewar) - 
...
- [winhub-emu/winhub](https://github.com/winhub-emu/winhub) - WinHub - The brand new, opensource one-stop place for all your games, now on Android.
...
- [gambino97/IntelXDataExtractor](https://github.com/gambino97/IntelXDataExtractor) - Intelligence X Data Extractor - a Python tool that extracts and filters leaked credentials from Intelligence X .zip archives. It processes emails, passwords, phone numbers, and metadata. Works on Wind
...
- [SDevTutors/track-ms-word-docx-with-github-docs](https://github.com/SDevTutors/track-ms-word-docx-with-github-docs) - Track changes in MS Word (.docx) files using GitHub and Pandoc for effective version control and collaboration.
...
- [pablouser1/aio-github-card](https://github.com/pablouser1/aio-github-card) - ⚠️ This repo has moved to https://codeberg.org/pablouser1/aio-profile-cards
...
- [matpato/iselreport](https://github.com/matpato/iselreport) - Template para relatório escrito em LaTex e Word
...
- [PrivacySafe/sticktock](https://github.com/PrivacySafe/sticktock) - Share TikToks Safely. No Ads, No Spyware, No Phone App.
- [duyfken/alternative-front-ends](https://github.com/duyfken/alternative-front-ends) - Privacy-respecting front-ends for popular platforms (e.g. YouTube, Reddit, Twitter, etc.)
- [Extravi/araa-search](https://github.com/Extravi/araa-search) - A privacy-respecting, ad-free, self-hosted Google metasearch engine with strong security that offers full API support and utilizes Qwant for images, and DuckDuckGo for auto-complete.
- [neon-mmd/websurfx](https://github.com/neon-mmd/websurfx) - :rocket: An open source alternative to searx which provides a modern-looking :sparkles:, lightning-fast :zap:, privacy respecting :disguised_face:, secure :lock: meta search engine
- [libredirect/browser_extension](https://github.com/libredirect/browser_extension) - A browser extension that redirects popular sites to alternative privacy friendly frontends
